...
rule plot_error_rates_and_NO_ratio:
    ...
    output:
        error_rates = report("results/{sample}/plots/single_read_error_rates.png", caption="../report/single_read_error_rates.rst", category="Plots", subcategory="Error rates: {sample}", labels={"Figure": "Error rates"}),
        NO_ratio = report("results/{sample}/plots/NO_ratios.png", caption="../report/NO_ratios.rst", category="Plots", subcategory="Error rates: {sample}", labels={"Figure": "NO-ratios"}),
    resources: 
